...
and its dependencies can be directly added to `spark-submit` using `--packages`, such as,
    ...
    ./bin/spark-submit --packages com.microsoft.azure:azure-eventhubs-spark_2.11:2.3.4 ...
...
For experimenting on `spark-shell`, you can also use `--packages` to add `azure-eventhubs-spark_2.11` and its dependencies directly,
    ...
    ./bin/spark-shell --packages com.microsoft.azure:azure-eventhubs-spark_2.11:2.3.4 ...
